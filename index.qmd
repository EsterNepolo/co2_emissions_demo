...
emissions_long = pd.melt(emissions,
id_vars="country",
...
countries_of_interest = ["Namibia", "Peru", "Kenya", "Uganda", "South Africa"]
for country in countries_of_interest:
    country_data = emissions_long_1990_2022.query("country == @country")
    print(country_data)

country_data = emissions_long_1990_2022.query("country in @countries_of_interest")
# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(country_data, x="year",
    y="emissions", color="country",
    title="Selected Countries CO2 Emissions (1990-2022)",
    markers=True,
    hover_name="country"
    )
